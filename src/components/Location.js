...
function Location() {
  ...
  const validate = () => {
    ...
    if (!addressData.hno.trim()) {
      ...
      errors.hno =
        "Allow numbers, small letters, capitals, hyphens, spaces, and slashes";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      if (addressData.id) {
        ...
        method = "POST";
        if (currentAddressType === "PresentAddress") {
          url = `http://192.168.0.117:8080/employeeservice/location/createPresentAddress?employeeId=HRMS1`;
        } else if (currentAddressType === "PermanentAddress") {
          url = `http://192.168.0.117:8080/employeeservice/location/CreatePermanentAddress?employeeId=HRMS1`;
        } else if (currentAddressType === "OfficeAddress") {
          url = `http://192.168.0.117:8080/employeeservice/location/createOfficeAddress?employeeId=HRMS1`;
        }
      }
